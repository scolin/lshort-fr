% contributeurs pour lshort-fr (encodé en latin1)
%
...
\label{lettrine}
\lettrine{C}{e document} est une traduction en français de \emph{The not so
  short introduction to \LaTeXe} par Tobias Oetiker.
...
Si vous êtes intéressés par la version allemande, vous trouverez une version
adaptée à \LaTeXe{} par J\"org Knappen sur \CTAN{info/lshort/german/} 


\newpage
Les presonnes suivantes ont proposé des corrections, des suggestions et du
texte pour améliorer ce document. Ils ont fournit un gros effort pour m'aider
à produire ce document tel que vous le voyez. Qu'ils en soient ici remerciés
sincèrement. Ajoutons que je suis responsable de toutes les erreurs que vous
...
\bigskip
Les versions françaises ont bénéficié des contributions des lecteurs du 
groupe \newsgroup{fr.comp.text.tex} et en particulier de :
{\flushleft\small 
...
\bigskip
\noindent\emph{Note des traducteurs} : nous tenons également à remercier
