...
set shortmess=aoO
badd +425 en-3.20/things.tex
badd +60 en-4.24/things.tex
badd +424 things.tex
badd +187 lshort-fr.sty
badd +1 lshort-fr.tex
badd +1 remarks
args en-3.20/things.tex en-4.24/things.tex
edit en-3.20/things.tex
...
532
normal zo
let s:l = 547 - ((0 * winheight(0) + 12) / 24)
...
565
normal zo
let s:l = 581 - ((1 * winheight(0) + 12) / 24)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
581
...
8
normal zo
let s:l = 549 - ((0 * winheight(0) + 12) / 24)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
549
