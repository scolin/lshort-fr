...
\item Créez/éditez votre fichier source \LaTeX. Il s'agit d'un
      ...
      fichier est sauvegardé en texte seul (ASCII ou encore « plain
      text »). Choisissez pour votre fichier un nom avec le suffixe
      \texttt{.tex}. 
...
% caractères spéciaux\footnote{Par exemple le caractère « souligné » :
