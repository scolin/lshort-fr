...
L'extension \pai{textcomp} fournit un symbole degré plus adapté, disponile
...
Mon\TeX{} supporte aussi bien le cyrillique que l'écriture mongole
...
Si vous préférez la modernité, utilsez \iei{utf8} à la place.
...
%MPG: déplacé ici et alongé pour remplir la page
