...
\item \TeX{} et \LaTeX{} ont été développés à l'origine pour des
...
nécessaire. \LaTeX{} vous indique quand c'est la cas.
...
\end{code}
\noindent Les sections suivantes présentent tous les environnements
importants.
...
pour indiquer les sauts de ligne, ceux-ci continue d'être calculés
automatiquement par \LaTeX{}.
...
\mfr{|} permet d'obtenir un filer vertical.
\index{"|@ \verb."|.} 
