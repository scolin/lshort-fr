...
\end{example}
Yes I know the renderin here is not ideal, it's realy grave accent and
vertical quote on your keyboard, despite what the font chosen might suggest.
...
The \pai{texcomp} package makes the degree symbol also available as \ci{textcelsius} and \ci{texdegree}.
...
Euro, under the name \ci{EUR}. It's disadvantag is that it does not provide
