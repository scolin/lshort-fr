...
\end{example}
Je suis conscient que le rendu ici n'est pas idéal, mais il s'agit
effectivement d'un accent grave et d'une quote (i.e. pas une
apostrophe au sens typographique du terme), et ce malgré ce que la
...
L'extension \pai{texcomp} met aussi à disposition le symbole degré via
les commandes \ci{textcelsius} et \ci{texdegree}.
...
utiliser soit l'extension \pai{europs} et la commande \ci{EUR} (pour
un symbole de l'Euro qui correspond à la police courante) soit
...
compris celui de l'Euro, sous le nom \ci{EUR}. Son défaut est de ne
...
fonctionnalité avec soin. Les codages suivants peuvent s'avérer utiles
en fonction du type de système sous lequel vous travaillez.
\footnote{Pour en savoir plus sur les codages d'entrée reconnus par
  \LaTeX{} pour les alphabets latins et cyrilliques, lisez la
...
system  & Alphabet latin & Alphabet cyrillique\\
 \hline
...
Si vous utilisez un document multilingue qui cause des conflits entre
...
\iei{utf8}, un codage multi-octets où chaque caractère peut nécessiter
...
\begin{table}[htb]
  ...
  \begin{tabular}{@{}p{.1\hsize}@{}p{.9\hsize}@{}}
   ...
   \verb|""| & comme |"-|, mais n'affiche pas le tiret
               (pour les mots composés avec tiret, p.e. \ |x-""y|
