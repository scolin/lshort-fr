...
\footnote{NdT. D'anciennes versions de ce document préconisent la
  ...
  \verb|\'|\verb|e| pour l'échange de documents \LaTeX{}. Cette
...
explicitement. \pai{babel} prendra en charge le changement de codage
de fonte lorsqu'un autre langage est sélectionné dans le document.
...
entouré d'espaces fines), le tiret pour le dialogue, des marques de
