...
qui manipulent les fichiers \eei{.dvi}. Ils sont disponibles sur la plupart
des systèmes Unix. Sur les autres systèmes, d'autres outils de
manipulation des fichiers \eei{.dvi} sont disponibles. 
...
\begin{description}
\item[\eei{.dvi}] signifie \emph{DeVice Independent}, c'est le fichier que l'on
...
\item[\eei{.toc}] contient le matériel nécessaire à la production de la
  table des matières, si celle-ci a été demandée. Ce fichier sera lu à
  la prochaine exécution de \LaTeX{} ;
