...
Cependant, les puristes ne cliquent pas ; voici donc comment demander
à \LaTeX{} de traiter votre document sur un système avec une interface
textuelle. Remarquez que ceci suppose que \LaTeX{} soit déjà installé
sur votre ordinateur (les puristes utilisent une déclinaison d'Unix).
...
Vous pouvez également transformer le résultat en PostScript pour
