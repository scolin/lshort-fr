...
traduit en français par Matthieu Herrb\\
(jusqu'à la version 3.20),\\[1.5ex]
par Samuel Colin\\
(à partir de la version 3.21)\\[3ex]} 
Version~4.24fr,\\
Août 2009\\
(non diffusée, traduction en cours)
\end{minipage}
\addtolength{\textwidth}{\centeroffset}
\vspace{\stretch{2}}
...
\begin{small} 
  ...
  Copyright \copyright{} 1995-2002 Tobias Oetiker et les contributeurs.
