...
\item[Le chapitre 1] présente la structure élémentaire d'un document
  ...
  avoir une vue générale de ce qu'est \LaTeX{}. Cette vue vous
  permettra d'y intégrer par la suite les informations des chapitres
  suivants.
...
\item[Le chapitre 4] explique comment réaliser un index, une liste de
  ...
  pdf\LaTeX{} ainsi que quelques autres extensions utiles comme
  XY-pic.
