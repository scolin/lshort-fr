...
Ça n'est cependant toujours pas une solution optimale puisque les
...
pourquoi il faut ajouter un peu d'espace \ci{:} entre ce signe et le
terme qui suit. Par exemple, au lieu de
\begin{example}
\begin{IEEEeqnarray}{rCl}
  a & = & b + c 
  \\
...
transmis à la prochaine ligne dont la numérotation n'est pas
...
compilation dans le cas où une commande \ci{IEEEmulticol} se
trouverai après la définition du label.
