...
Se other kinds of arrows like $\hookrightarrow$ and $\rightleftharpoons$ on
...
The \pai{amsthm} package (part of \AmS-\LaTeX) provides the \ci{newtheoremstyle}\verb|{|\emph{style}\verb|}|
