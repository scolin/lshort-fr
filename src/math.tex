...
% $Id: math.tex 431 2010-07-06 20:53:05Z oetiker $
%
...
Ça n'est cependant toujours pas une solution optimale :
\begin{itemize}
...
\item L'environnement propose une commande \ci{lefteqn} qui peut être utilisée
...
\end{eqnarray}
\end{example}
Une fois encore, ça n'est pas optimal étant donné que le membre de droite
...
\item Pour supprimer la numérotation sur une ligne particulière, on dispose de
  ...
  prochaine ligne dont la numérotation n'est pas supprimée. Placez plutôt
  les labels juste avant le \verb+\\+ à la fin de
