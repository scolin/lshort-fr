...
% $Id: math.tex 532 2014-10-20 13:45:34Z oetiker $
%
...
Parfois, l'espacement par défaut suffit, comme par exemple devant
\begin{itemize}
...
\end{itemize}
un signe $+$ ou $-$ peut ne pas être unaire et doit être un opérateur
binaire. Dans ce cas, \LaTeX{} ajuste correctement l'espace après le signe,
