...
\LaTeX{}: il s'agit donc d'une commande (ce qui explique l'usage de
...
De nos jours, tout système de génération de sortie \LaTeX{} (\texttt{dvips},
...
Si vous être programmeur, vous aurez remarqué l'usage, familier,
du point-virgule (\texttt{;}) pour séparer les instructions. Avec la
