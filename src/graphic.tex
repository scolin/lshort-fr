...
A \ei{picture} environment is created with one of the two commands
\begin{lscommand}
...
\subsection{The \ci{multiput} and the \ci{linethickness} command}
...
\subsection{Ovals. The \ci{thinlines} and the \ci{thicklines} command}
