...
\end{code}
%
in the preamble. This will normally detect the italic and bold version as
well, thus \verb|\textit| and \verb|\textbf| will work as usual. When the
...
dependent, a ligature used in Polish (fk) is not used in English. You have
to add
...
version, it was of by default in earlier releases.}. The result is a stylish
...
\url{.../texmf-dist/fonts/opentype} just install them in you operating
...
operating system have some sort of virtual keyboard, just make a
screenshot.) 
