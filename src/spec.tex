...
% $Id: spec.tex 449 2010-12-14 16:53:51Z oetiker $
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\PSi{} \fg{} que vous utilisez. Le programme le plus répandu
...
\CTAN|fonts/ps-type1/cm-super| et est fourni avec \TeX{}Live
...
L'extension \pai{hyperref}\footnote{%
  ...
  \texttt{dvips} et enfin reconnues par l'interpréteur \PSi{} lors de la
...
nous voulons que la version \PSi{} soit en noir et blanc à cause
...
La plupart des propos applicables à pdf\LaTeX\ sont également valides
pour \hologo{XeLaTeX}.
