...
Si cependant vous utilisez \LaTeX{} dans d'autres langues que
...
Comme vous le constatez, ces histoires, en particulier le manque d'une bonne
police EC de qualité équivalente à la police CM au format type~1, ont
occupé les esprits de nombreuses personnes. Depuis 2003, un nouvel
...
%MPG: rewritten to tell the truth
Remarquez que dans les distributions \TeX{} récentes (comme \TeX{}Live,
Mac\TeX{} et MiK\TeX), le programme \TeX{} par défaut est en fait pdf\TeX{}.
Il s'adaptera automatiquement à la production de pdf ou de dvi en fonction de
la façon dont vous l'appelez : utilisez la commande \verb|pdflatex| pour
