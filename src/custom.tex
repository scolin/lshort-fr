...
plus loin. Pour la commande \ci{rule}, voyez page~\pageref{sec:rule},
pour \ci{stretch}, voyez page~\pageref{cmd:stretch} enfin, pour plus
d'informations sur \ci{hspace}, voyez page~\pageref{sec:hspace}.
...
\fni{textrm}\verb|{...}|        &      \textrm{\wi{romaine}}&
\fni{textsf}\verb|{...}|        &      \textsf{\wi{sans serif}}\\
\fni{texttt}\verb|{...}|        &      \texttt{machine à écrire}\\[6pt]
\fni{textmd}\verb|{...}|        &      \textmd{graisse normale}&
\fni{textbf}\verb|{...}|        &      \textbf{\wi{grasse}}\\[6pt]
\fni{textup}\verb|{...}|        &       \textup{\wi{droite}}&
\fni{textit}\verb|{...}|        &       \textit{\wi{italique}}\\
\fni{textsl}\verb|{...}|        &       \textsl{\wi{penchée}}&
\fni{textsc}\verb|{...}|        &       \textsc{\wi{Petites Capitales}}\\[6pt]
\ci{emph}\verb|{...}|          &            \emph{en évidence} &
\fni{textnormal}\verb|{...}|    &    police \textnormal{par défaut}
\end{tabular}
...
\fni{mathtt}\verb|{...}|&     $\mathtt{Police\ machine\ à\ écrire}$\\
...
{\setlength{\baselineskip}%
           {1.5\baselineskip}
Ce paragraphe est formatté avec un
interligne fixé à 1,5 de ce qu'il
était avant. Remarquez la commande
par à la fin du paragraphe.\par}

Ce paragraphe a un objet précis et
montre qu'après l'accolade, fermante
...
environnement dans \ei{minipage}, alors que ce n'est pas le cas avec
\ci{parbox}.
